...
/**
 * Activity with a ViewPager that present information about the department
 */
public class BachelorActivity extends BaseActivity {
	...
	private class ContentPagerAdapter extends FragmentPagerAdapter {
		private String[] filenames = getResources().getStringArray(R.array.bcs_filenames);
		private String[] titles = getResources().getStringArray(R.array.bcs_titles);
